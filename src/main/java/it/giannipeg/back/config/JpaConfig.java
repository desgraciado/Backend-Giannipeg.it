package it.giannipeg.back.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "it.giannipeg.back.repository", transactionManagerRef = "jpaTransactionManager")
@PropertySource(value = { "classpath:application.properties" })
@EnableTransactionManagement
public class JpaConfig {

	private static final String[] ENTITYMANAGER_PACKAGES_TO_SCAN = { "it.giannipeg.back.entity" };
